function selection(value){
    ...
    switch(value){
        case "a": document.getElementById("selected-ibm").innerHTML = "I've been enhancing my programming skills by delving into concepts such as SOLID principles, design patterns, and maintaining clean code practices. I've also been exploring advanced techniques like event-driven programming, queue management, and authentication. My preferred programming languages are Java and C#, and I particularly enjoy working with Spring and ASP .NET Core frameworks.";break;
        case "b": document.getElementById("selected-ibm").innerHTML = "I've been enhancing my Cloud Computing skills through the implementation of infrastructure and resources in AWS. My preferred method for achieving this is utilizing Terraform to efficiently build and provision the necessary components for implementation. Furthermore, And the GitHub has integrated platform with the AWS ecosystem to enable CI/CD processes.";break;
