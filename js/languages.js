function switchLanguage(){
    ...
    if(value ==  "br"){
        ...
        document.getElementById("curriculo").setAttribute("href", "https://docs.google.com/document/d/1Ky2eIi2wJ4HaBb3JXH35EHS5p-BIJJ_c/edit?usp=sharing&ouid=117834716618908744232&rtpof=true&sd=true");
        ...
        document.getElementById("description-ibm-ml").innerHTML = "Experiência na construção de sistemas IA/ML com foco em MLOps, FMOps e infraestrutura. Entrega de soluções em produção utilizando MLflow, AWS, Terraform, Kubernetes e práticas de CI/CD. Especializado em integração com LLMs e sistemas agentic com LangChain e bancos vetoriais, aplicações no setor financeiro.";
