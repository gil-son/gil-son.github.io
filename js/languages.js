function switchLanguage(){
    ...
    if(value ==  "br"){
        ...
        document.getElementById("description-ibm-ml").innerHTML = "Experiência na construção de sistemas IA/ML com foco em MLOps, FMOps e infraestrutura. Entrega de soluções em produção utilizando MLflow, AWS, Terraform e práticas de CI/CD. Especializado em integração com LLMs e sistemas agentic com LangChain e bancos vetoriais, aplicações no setor financeiro.";
